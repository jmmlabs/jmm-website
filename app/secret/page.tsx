  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start py-10 px-4 bg-background text-foreground">
      ...
      <button
        type="button"
        onClick={() => router.back()}
        className="self-start mt-4 ml-2 sm:mt-6 sm:ml-6 px-3 py-2 sm:px-4 sm:py-2 rounded-lg bg-card/80 text-foreground border border-border shadow hover:bg-muted transition-colors focus:outline-none focus:ring-2 focus:ring-primary/60 backdrop-blur-sm text-sm sm:text-base"
        aria-label="Go back"
      >
